...
class AddBourbonCategoryViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        // Remove the hardcoded title here since we'll set it dynamically
    ...
    @objc private func continueButtonTapped() {
        ...
        case .purchases:
            let addVC = AddBourbonViewController()
            addVC.delegate = self
            navigationController?.pushViewController(addVC, animated: true)
            
        case .tastings:
            let addVC = AddTastingViewController()
            addVC.delegate = self
            navigationController?.pushViewController(addVC, animated: true)
            
        case .infinity:
            // TODO: Create and push InfinityViewController
            let alert = UIAlertController(
                title: "Coming Soon",
                message: "The Infinity feature is under development.",
